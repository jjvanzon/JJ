//
//  Circle.Integration.DotNet.EvenOlderAdapter
//
...
namespace Circle.Integration.DotNet
{
    public class EvenOlderAdapter
    {
        ...
        private AssemblyAdapter AssemblyAdapter = new AssemblyAdapter();
        ...
        public void ExecuteWithLiteral(string dotNetLiteral, Item item, bool clear = true, Item parentItem = null)
        {
            ...
            else if (dotNetLiteral.EndsWith(":dotnet"))
            {
                ...
                try
                {
                    Assembly assembly = AssemblyAdapter.LoadByFilePath(dotNetLiteral.CutRight(":dotnet"));
                    if (assembly != null)
                    {
                        item.IsModule = true;
            ...
            else if (dotNetLiteral.Contains(','))
            {
                ...
                try
                {
                    ...
                    AssemblyAdapter assembly = new AssemblyAdapter();
                    if (assembly.LoadByName(assemblyName) != null)
                    {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        // Single Assembly
                        Assembly assembly = AssemblyAdapter.LoadByName(dotNetLiteral);
                        if (assembly != null)
                        {
                            item.IsModule = true;
                            ExecuteForAssembly(assembly, item, clear: false);
