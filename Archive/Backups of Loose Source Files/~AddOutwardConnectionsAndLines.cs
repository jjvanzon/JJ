...
namespace Circle.Diagram.Engine
{
    ...
    /// 
    /// </summary>
    public class AddOutwardConnectionsAndLines : StepWithDiagram
    {
        /// <summary>
        ...
        public void Clear()
        {
            foreach (Shape shape in Diagram.Shapes)
            {
                ...
                shape.ConnectedLines.Clear();
                shape.LinePointingAway = null;
            }
            Diagram.Lines.Clear();
        }
        ...
        private bool Scan(Shape higherImaginaryShape, Shape parent)
        {
            ...
            foreach (Shape child in parent.Children.OrderByDescending(x => x.IsImaginary || x.UsedAsImaginary)) // ChildrenImaginaryFirst
            {
                ...
                line.ShapePointedAt = higherImaginaryShape;
                line.ShapePointing = child;
                // Debugging
                Debug(higherImaginaryShape, child, line);
                // Remove temporary line
                Diagram.Lines.Remove(line);
                ...
                higherImaginaryShape.ConnectedLines.Add(line);
                line.ShapePointedAt = higherImaginaryShape;
                line.ShapePointing = child;
                child.ShapePointedAt = higherImaginaryShape;
                child.LinePointingAway = line;
